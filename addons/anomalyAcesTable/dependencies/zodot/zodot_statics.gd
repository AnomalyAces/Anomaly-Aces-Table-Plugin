...
static func label() -> z_label:
	return z_label.new()

static func base_button() -> z_base_button:
	return z_base_button.new()

static func texture_rect() -> z_texture_rect:
	return z_texture_rect.new()
